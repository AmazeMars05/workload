                ...
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="card-title">
                                    <center>School-2 name</center>
                                </h1>
                                <p class="card-description"> School-2 name available products list.</p>
                                ...
                                <form class="form-inline" action="add" method="post">
                                    ...
                                    <input type="hidden" class="form-control" id="sid" name="sid" value="2">
                                    <div class="input-group mb-2 mr-sm-2">
