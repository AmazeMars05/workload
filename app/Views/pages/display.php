    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-2 bg-dark height">
                ...
                <hr class="bg-light ">
                <p class="pt-2 pb-2 text-center">
                    <a href="add.php" class="text-decoration-none"><span class="text-light">Add Products</span></a>
                </p>
                <hr class="bg-light ">
                <p class="pt-2 pb-2 text-center">
                    <a href="display.php" class="text-decoration-none"><span class="text-light">Browse Products</span></a>
                </p>
                <hr class="bg-light ">
                <p class="pt-2 pb-2 text-center">
                                ...
                                <?php while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) { ?>
                                    <tr>
                                        <form method="post" id="the-form" enctype="multipart/form-data">
                                            <td><input type="text" class="form-control" name="school-name" value="<?php echo ($row1['sid']); ?>" readonly></td>
                                            <td><input type="text" class="form-control" name="product-name" value="<?php echo ($row1['pname']); ?>"></td>                                            
                                            <input type="hidden" class="form-control" id="poid" name="poid" value="<?php echo ($row1['poid']);  ?>" readonly>
