...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo site_url('assets/vendors/jvectormap/jquery-jvectormap.css'); ?>">
    <link rel="stylesheet" href="<?php echo site_url('assets/vendors/flag-icon-css/css/flag-icon.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo site_url('assets/vendors/owl-carousel-2/owl.carousel.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo site_url('assets/vendors/owl-carousel-2/owl.theme.default.min.css'); ?>">
